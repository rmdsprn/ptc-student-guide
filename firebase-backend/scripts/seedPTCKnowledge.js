...
async function seed() {
  const data = [
    ...
    // ✅ NEW – President info
    {
      category: "college_info",
      content:
        "The President of Pateros Technological College is Dr. Analiza F. Arcega."
    },
    {
      category: "college_info",
      content:
        "Pateros Technological College is currently headed by its President, Dr. Analiza F. Arcega."
    },
